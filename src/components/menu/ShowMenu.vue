<template>
  <div id="show-menu">
    <div class="menu-cont">
      <div class="logo">
        <a target="_blank" href="https://github.com/ZengTianShengZ/resume-vue"
          ><i class="icon-github icon-5x"></i
        ></a>
      </div>
      ...
      <transition name="fade">
        <div class="download-choice" v-show="showDownloadChoice">
          <div class="dpi96 setdpi">
            ...
            <input
              type="radio"
              @click="choiceClick({ width: 794, height: 1123 })"
            />
          </div>
          <div class="dpi120 setdpi">
            ...
            <input
              type="radio"
              @click="choiceClick({ width: 1487, height: 2015 })"
            />
          </div>
          <div class="custom">
            width :<input
              type="text"
              v-model="customPx.width"
              placeholder="px"
            />
            height:<input
              type="text"
              v-model="customPx.height"
              placeholder="px"
            />
            <span
              class="ok-choice"
              @click="
                choiceClick({
                  width: parseInt(customPx.width),
                  height: parseInt(customPx.height),
                })
              "
              >down</span
            >
